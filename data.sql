...
INSERT INTO visits (animals_id, vets_id, date_of_visit) VALUES ((SELECT id FROM animals WHERE name = 'Chamander'), (SELECT id FROM vets WHERE name = 'Jack Harkness'), '2021-02-24');
